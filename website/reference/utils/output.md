...
源码：`objection/utils/output.py:80`
...
### 统一 JSON Schema
源码：`objection/utils/output.py:16`（模块 docstring）与 `to_dict` 实现：
...
### `output_result` — 渲染分流
源码：`objection/utils/output.py:129`
...
源码：`objection/utils/output.py:116`
...
源码：`objection/utils/output.py:182`
...
源码：`objection/utils/output.py:44`
...
### `error_result` — 错误快捷构造
源码：`objection/utils/output.py:164`
...
### `emit_event` — 异步事件流
源码：`objection/utils/output.py:203`
...
源码：`objection/utils/output.py:226`
...
| 符号 | 位置 |
| --- | --- |
| `_capture_stack` | `objection/utils/output.py:44` |
| `push_result_capture` | `objection/utils/output.py:47` |
| `pop_result_capture` | `objection/utils/output.py:62` |
| `_capturing` | `objection/utils/output.py:74` |
| `CommandResult` | `objection/utils/output.py:80` |
| `CommandResult.to_dict` | `objection/utils/output.py:104` |
| `is_json_output` | `objection/utils/output.py:116` |
| `output_result` | `objection/utils/output.py:129` |
| `error_result` | `objection/utils/output.py:164` |
| `should_output_json` | `objection/utils/output.py:182` |
| `emit_event` | `objection/utils/output.py:203` |
| `set_json_output` | `objection/utils/output.py:226` |
